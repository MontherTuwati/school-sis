        ...
        <div class="content container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                                    ...
                                    <div class="col-lg-4 col-md-4">
                                        <div class="profile-user-box">
                                            <div class="profile-user-img">
                                                <img src="{{ Storage::url('department-photos/'.$departmentProfile->upload) }}" alt="Profile">
                                                <div class="form-group departments-up-files profile-edit-icon mb-0">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="department-personals-grp">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="personal-activity">
                                            ...
                                            <div class="views-personal">
                                                <h4>Mobile</h4>
                                                <h5>{{ $departmentProfile->phone_number }}</h5>
                                            </div>
                                        </div>
                                        <div class="personal-activity">
                                            <div class="personal-icons">
                                            ...
                                            <div class="views-personal">
                                                <h4>Email</h4>
                                                <h5><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="81e5e0e8f2f8c1e6ece0e8edafe2eeec">{{ $departmentProfile->email }}</a>
                                                </h5>
                                            </div>
                                        </div>
                                        <div class="personal-activity">
                                            ...
                                            <div class="views-personal">
                                                <h4>Gender</h4>
                                                <h5>{{ $departmentProfile->gender }}</h5>
                                            </div>
                                        </div>
                                        <div class="personal-activity">
                                            <div class="personal-icons">
                                            ...
                                            <div class="views-personal">
                                                <h4>Date of Birth</h4>
                                                <h5>{{ $departmentProfile->date_of_birth }}</h5>
                                            </div>
                                        </div>
                                        <div class="personal-activity">
                                            <div class="personal-icons">
