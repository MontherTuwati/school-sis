        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Coursess</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">Coursess</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        ...
                                        <a href="{{ route('course/add/page') }}" class="btn btn-primary">
                                ...
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="actions">
                                                    <a href="{{ url('course/edit/'.$value->course_code) }}" class="btn btn-sm bg-danger-light">
                    ...
                    <div class="modal-btn delete-action">
                        <div class="row">
                            <form action="{{ route('course/delete') }}" method="POST">
                                @csrf
                                <input type="hidden" name="course_code" class="e_course_code" value="">
                                <div class="row">
                                    <div class="col-6">
    ...
    @section('script')
        ...
        <script>
            $(document).on('click','.delete',function()
            {
                ...
                $('.e_course_code').val(_this.find('.course_code').text());
            });
        </script>
    @endsection
