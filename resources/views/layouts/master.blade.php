...
<body>
    <div class="main-wrapper">
                    ...
                    <div class="dropdown-menu ">
                        <div class="noti-content">
                            <div>
                                ...
                                <a class="dropdown-item" href="javascript:;"><i class="flag flag-ly me-2"></i>Arabic</a>
                            </div>
                        </div>
                    </div>
                </li>
                                        ...
                                        <a href="#">
                                            <div class="media d-flex">
                                                ...
                                                <div class="media-body flex-grow-1">
                                                    <div>{{ $notification->message }} (by {{ $notification->user->name }})</div>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
        ...
        @if(auth()->check())
            ...
            @if($role === 'Admin' && view()->exists("sidebar.admin-sidebar"))
                @include("sidebar.admin-sidebar")
            @elseif($role === 'Department Manager' && view()->exists("sidebar.department-sidebar"))
                @include("sidebar.department-sidebar")
            @elseif($role === 'Super Admin' && view()->exists("sidebar.sidebar"))
        ...
        @yield('content')
        <footer>
            <p>Copyright ©  <?php echo date('Y'); ?> MTEch</p>
        </footer>
