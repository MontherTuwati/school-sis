                            ...
                            <form action="{{ route('user/update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select" name="role">
                                                ...
                                                <option value="Department Manager" {{ $users->role == 'Department Manager' ? 'selected' : '' }}>Department Manager</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select @error('departments') is-invalid @enderror" name="departments">
