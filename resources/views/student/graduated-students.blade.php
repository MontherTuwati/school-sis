                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">Graduated Students</h3>
                            <ul class="breadcrumb">
                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        ...
                                        <a href="{{ route('student/grid') }}" class="btn btn-outline-gray me-2"><i class="fa fa-th "></i></a>
                                        <a href="{{ route('student/graduates') }}" class="btn btn-outline-gray me-2 active"><i class="fa fa-graduation-cap "></i></a>
                                    </div>
                                </div>
                            </div>
