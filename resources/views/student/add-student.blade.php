                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="form-title student-info">Student Information
                                            <span>
                                                <a href="javascript:;"><i class="fa fa-address-card"></i></a>
                                            </span>
                                        </h5>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" class="form-control @error('guardian_name') is-invalid @enderror" name="guardian_name" placeholder="Enter Guardian Name" value="{{ old('guardian_name') }}">
                                            @error('guardian_name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input type="text" class="form-control @error('guardian_number') is-invalid @enderror" name="guardian_number" placeholder="Enter Guardian Number" value="{{ old('guardian_number') }}">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select  @error('gender') is-invalid @enderror" name="gender">
                                                ...
                                                <option value="Others" {{ old('gender') == 'Others' ? "selected" :"Others"}}>Others</option>
                                            </select>
                                            @error('gender')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            <label>Nation ID <span class="login-danger">*</span></label>
                                            <input class="form-control @error('nation_id') is-invalid @enderror" type="text" name="nation_id" placeholder="Enter Nation ID" value="{{ old('nation_id') }}">
                                            @error('nation_id')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-12">
                                        <h5 class="form-title student-info"> Department Information
                                            <span>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select @error('semester') is-invalid @enderror" name="semester">
                                                ...
                                                <option value="4" {{ old('semester') == '3' ? "selected" :""}}>Semester 3</option>
                                            </select>
                                            @error('semester')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                        ...
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select @error('departments') is-invalid @enderror" name="departments">
                                                ...
                                                @foreach($departments as $department)
                                                    <option value="{{ $department->id }}" {{ old('departments') == $department->id ? "selected" : ""}}>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select @error('subjects') is-invalid @enderror" name="subjects">
                                                <option selected disabled>Please Select Subject</option>
                                                @foreach($subjects as $subject)
                                                    <option value="{{ $subject->id }}" {{ old('subjects') == $subject->id ? "selected" : ""}}>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <div class="upload">
                                                <label class="file-upload image-upbtn mb-0 @error('upload') is-invalid @enderror"></label>
