                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select class="form-control select @error('class') is-invalid @enderror" name="class">
                                                ...
                                                <option value="1" {{ $studentEdit->class == '1' ? "selected" :""}}>Semester 1</option>
                                                <option value="2" {{ $studentEdit->class == '2' ? "selected" :""}}>Semester 2</option>
                                                <option value="3" {{ $studentEdit->class == '3' ? "selected" :""}}>Semester 3</option>
                                                <option value="4" {{ $studentEdit->class == '4' ? "selected" :""}}>Semester 4</option>
                                            </select>
                                            @error('class')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control @error('department_id') is-invalid @enderror" type="text" name="department_id" value="{{ $studentEdit->department_id }}">
                                            @error('department_id')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
